...
ggplot(iit, aes(x=INCIDENT_TYPE2)) + geom_bar(fill="steelblue", alpha = .8)+ 
  ...
  labs(title="IIT Campus and surrounding area crime incidents by type frequency") + labs(x="Incident type", y="Frequency")
...
ggplot(iitCrime, aes(x=MONTH)) + geom_bar(fill="steelblue", alpha = .8)+ 
  geom_text(aes(y = ((..count..)/sum(..count..)), label = scales::percent((..count..)/sum(..count..))), stat = "count", vjust=1.5, position=position_dodge(.9), size=3) +
    labs(title="IIT Campus and surrounding area crime incidents by month") + labs(x="Month", y="Frequency")

#plot incidents by month for IIT camp
ggplot(iitCampCrime, aes(x=MONTH)) + geom_bar(fill="steelblue", alpha = .8)+ 
  geom_text(aes(y = ((..count..)/sum(..count..)), label = scales::percent((..count..)/sum(..count..))), stat = "count", vjust=1.5, position=position_dodge(.9), size=3) +
  labs(title="IIT Campus crime incidents by month") + labs(x="Month", y="Frequency")

#plot incidents by month for IIT area
ggplot(iitAreaCrime, aes(x=MONTH)) + geom_bar(fill="steelblue", alpha = .8)+ 
  geom_text(aes(y = ((..count..)/sum(..count..)), label = scales::percent((..count..)/sum(..count..))), stat = "count", vjust=1.5, position=position_dodge(.9), size=3) +
...
ggplot(iitCampCrime, aes(x=DAY)) + geom_bar(fill="steelblue", alpha = .8)+ 
  geom_text(aes(y = ((..count..)/sum(..count..)), label = scales::percent((..count..)/sum(..count..))), stat = "count", vjust=1.5, position=position_dodge(.9), size=3) +
  labs(title="IIT campus crime incidents by weekdays") + labs(x="Weekday", y="Frequency")
...
ggplot(iitCrime, aes(x=TIME_BUCKET)) + geom_bar(fill="steelblue", alpha = .8)+ 
  geom_text(aes(y = ((..count..)/sum(..count..)), label = scales::percent((..count..)/sum(..count..))), stat = "count", vjust=1.5, position=position_dodge(.9), size=3) +
  labs(title="IIT campus and surrounding area crime incidents by time of day") + labs(x="Time of day", y="Frequency")
...
crimeTime <- aggregate(iitCrime$INCIDENT_TYPE2, by=list(iitCrime$INCIDENT_TYPE2, iitCrime$TIME_BUCKET), FUN=length)
names(crimeTime) <- c("Crime_type", "Time_interval", "Frequency")

crimeTime$Frequency[which(crimeTime$Crime_type=='PERSON CRIME')] <- rescale(crimeTime$Frequency[which(crimeTime$Crime_type=='PERSON CRIME')], to = c(0, 1))
crimeTime$Frequency[which(crimeTime$Crime_type=='PROPERTY CRIME')] <- rescale(crimeTime$Frequency[which(crimeTime$Crime_type=='PROPERTY CRIME')], to = c(0, 1))
...
ggplot(crimeTime, aes(x=Crime_type, y=Time_interval)) +
  ...
  scale_fill_gradient("Crime frequency", low = "white", high = "steelblue", guide = 'none') +
  theme_bw() + ggtitle("Frequency of crime by type by time intervals") +
...
crimeTime <- aggregate(iitCrime$INCIDENT_TYPE2, by=list(iitCrime$INCIDENT_TYPE2, iitCrime$DAY), FUN=length)
...
ggplot(crimeTime, aes(x=Crime_type, y=Day)) +
  ...
  scale_fill_gradient("Crime frequency", low = "white", high = "steelblue", guide = 'none') +
  theme_bw() + ggtitle("Frequency of crime by type by day of the week") +
  theme(panel.grid.major = element_line(colour = NA), panel.grid.minor = element_line(colour = NA)) 
-----------------------------------------------------------
...
crimeTime <- aggregate(iitCrime$INCIDENT_TYPE2, by=list(iitCrime$INCIDENT_TYPE2, iitCrime$MONTH), FUN=length)
...
ggplot(crimeTime, aes(x=Crime_type, y=Month)) +
  ...
  scale_fill_gradient("Crime frequency", low = "white", high = "steelblue", guide = 'none') +
  theme_bw() + ggtitle("Frequency of crime by type by month") +
  theme(panel.grid.major = element_line(colour = NA), panel.grid.minor = element_line(colour = NA)) 
-----------------------------------------------------------
